...
void roulette()
{
    ...
    cin >> rouletteOption;
    // option for betting on red or black.
    if(rouletteOption == 1)
    {
    ...
    // Option is for betting on odds or evens
    ...
    // Option for selecting single numbers
    else if(rouletteOption == 3)
    {
        ...
        int randomNumber = 0;
        int moneyWagered = 0;
        // Continues until a break occurs
        while(true)
        {
            srand( static_cast<unsigned int>(time(NULL)));
            ...
            // Checks if number is one of the following...
            ...
            cout << "Your money: $"<< playerMoney << endl;
            cin >> moneyWagered;
            // Subtracts the wagered money from starting money
            playerMoney = playerMoney - moneyWagered;
            if(playerMoney > 0)
            {
